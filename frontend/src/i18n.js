...
const resources = {
  English: {
    translation: {
      ...
      resetBtnLoad: "Resetting...",
      resetSuccess: "Password reset successful",
      resetError: "Something went wrong. Please try again.",
      tokenVerify: "Verifying token...",
      tokenInvalid: "Invalid or expired token. Redirecting...",
      ...
      home: {
        ...
        Plans: {
          ...
          buildYourPerfectPlan: "Build Your Perfect Plan",
          mixAndMatchServices:
            "Mix and match services to create a subscription that fits your exact needs and budget.",
          customPricing: "Custom Pricing",
          chooseSpecificServices: "Choose specific services you need",
          flexibleBillingCycles: "Flexible billing cycles",
          billingOptions: "Monthly, quarterly, or annual payment options",
          discountsForMultipleServices: "Discounts for multiple services",
          freeInitialConsultation: "Free initial consultation",
          easyPlanAdjustments: "Easy plan adjustments",
          proposeYourPlan: "Propose Your Plan",
        },
        services: {
      ...
      contactUs: {
        ...
        submitTestimonial: "Submit Your Testimonial",
        rating: "Rating (1 to 5)",
        yourMessage: "Your Message",
        placeholderMessage: "Share your experience...",
        submitButton: "Submit",
      ...
      toastMessage: {
        ...
        bookingError: "Error occurred while making a booking request",
        ...
        youMustBeLoggedIn: "You must be logged in to subscribe to a plan.",
        paymentInitiationFailed: "Payment initiation failed.",
        errorInitiatingPayment: "Error initiating payment.",
        errorSubmittingTestimonial:
          "You need to be logged in to submit a testimonial.",
        testimonialSuccessful: "Testimonial added successfully!",
        testimonialFailure: "Error adding testimonial",
        alreadyReviewed:
  ...
  Nepali: {
    translation: {
      ...
      language: "भाषा",
      logout: "बाहिर निस्कनुहोस्",
      logout_confirmation: "के तपाईं निश्चित रूपमा बाहिर निस्कन चाहनुहुन्छ?",
      yes_logout: "हो, बाहिर निस्कनुहोस्",
      title: "पासवर्ड बिर्सनुभयो",
      emailLabel: "इमेल ठेगाना",
      button: "रिसेट लिङ्क पठाउनुहोस्",
      buttonLoading: "पठाउँदै...",
      success: "पासवर्ड रिसेट लिङ्क पठाइयो! तपाईंको इमेल जाँच गर्नुहोस्।",
      ...
      resetBtnLoad: "रिसेट गर्दै...",
      resetSuccess: "पासवर्ड रिसेट सफल भयो",
      resetError: "केही गडबड भयो। कृपया फेरि प्रयास गर्नुहोस्।",
      tokenVerify: "टोकन प्रमाणीकरण गर्दै...",
      tokenInvalid: "अमान्य वा म्याद सकिएको टोकन। पुनर्निर्देशन गर्दै...",
      noToken: "कुनै रिसेट टोकन प्रदान गरिएको छैन",
      tokenNotValid: "टोकन मान्य छैन",
      passMismatch: "पासवर्डहरू मेल खाँदैनन्",
      // About Us Section
      hero: {
        title: "हाम्रो बारेमा",
      },
      ...
      home: {
        ...
        Plans: {
          ...
          buildYourPerfectPlan: "आफ्नो उत्तम योजना निर्माण गर्नुहोस्",
          mixAndMatchServices:
            "आफ्नो आवश्यकताहरू र बजेट अनुसार सदस्यता सिर्जना गर्न सेवाहरू मिलाउनुहोस्।",
          customPricing: "अनुकूल मूल्य निर्धारण",
          chooseSpecificServices:
            "तपाईंलाई आवश्यक विशिष्ट सेवाहरू चयन गर्नुहोस्",
          flexibleBillingCycles: "लचिलो बिलिङ चक्रहरू",
          billingOptions: "मासिक, त्रैमासिक, वा वार्षिक भुक्तानी विकल्पहरू",
          discountsForMultipleServices: "धेरै सेवाहरूको लागि छुट",
          freeInitialConsultation: "नि:शुल्क प्रारम्भिक परामर्श",
          easyPlanAdjustments: "सजिलो योजना समायोजन",
          proposeYourPlan: "आफ्नो योजना प्रस्ताव गर्नुहोस्",
        },
        services: {
      ...
      contactUs: {
        ...
        submitTestimonial: "तपाईंको प्रशंसा पठाउनुहोस्",
        rating: "रेटिङ (१ देखि ५)",
        yourMessage: "तपाईंको सन्देश",
        placeholderMessage: "तपाईंको अनुभव साझा गर्नुहोस्...",
        submitButton: "पठाउनुहोस्",
        issubscribed: "तपाईं सदस्यता लिइसक्नुभएको छ!",
        form: {
      ...
      toastMessage: {
        ...
        bookingError: "बुकिङ अनुरोध गर्दा त्रुटि भयो",
        reviewDeleted: "समीक्षा सफलतापूर्वक हटाइयो",
        reviewDeleteError: "समीक्षा हटाउने क्रममा त्रुटि भयो",
        daysOfWeek: ["आइत", "सोम", "मंगल", "बुध", "बिही", "शुक्र", "शनि"],
        noReviewsYet: "अझै सम्म कुनै समीक्षा छैन।",
        delete: "मेट्नुहोस्",
        anonymous: "गोप्य",
        bookingSlots: "बुकिङ स्लटहरू: अंग्रेजी मिति",
        selectDate: "मिति चयन गर्नुहोस्",
        noSlotsAvailable: "कुनै स्लट उपलब्ध छैन",
        bookAService: "सेवा बुक गर्नुहोस्",
        selectDateAndTime: "मिति र समय चयन गर्नुहोस्",
        fee: "सेवा शुल्क:",
        aboutService: "सेवाबारे",
        failedToLoadSubscriptions: "सब्सक्रिप्सन लोड गर्न असफल।",
        youMustBeLoggedIn: "तपाईंले योजना सदस्यता लिनको लागि लगइन गर्नुपर्नेछ।",
        paymentInitiationFailed: "भुक्तानी सुरूवात असफल।",
        errorInitiatingPayment: "भुक्तानी सुरूवातमा त्रुटि।",
        errorSubmittingTestimonial:
          "तपाईंलाई प्रशंसा पठाउनका लागि लगइन गर्नुपर्नेछ।",
        testimonialSuccessful: "प्रशंसा सफलतापूर्वक थपियो!",
        testimonialFailure: "प्रशंसा थप्नमा त्रुटि!",
        alreadyReviewed:
          "तपाईंले यस बुकिङको लागि पहिले नै समीक्षा पेश गर्नुभएको छ।",
      ...
      footer: {
        ...
        contactUs: "सम्पर्क गर्नुहोस्",
        contactNumber: "+९७७ ९८७६४४५६७८",
        address: "बलाजु, काठमाडौं",
        country: "नेपाल",
