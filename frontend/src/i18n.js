...
const resources = {
  English: {
    translation: {
      ...
      bookingCancelError: "An error occurred while cancelling booking",
      registerFailed: "Failed to register user",
      loginFailed: "Failed to log in",
      authError: "An error occurred during authentication",
      loginPayment: "Please login to verify payment",
      paymentVerifySuccess: "Payment verified successfully",
      loginToSubscribe: "You must be logged in to subscribe to a plan",
      paymentInitiateFailed: "Failed to initiate payment",
      passwordResetFailed: "Failed to send password reset email",
      passwordResetError:
        "An error occurred while sending password reset email",
      serviceNotAvailable: "Service is not available right now",
      enterContactDetails:
        "Please enter your number and address correctly before booking",
      serviceBookSuccess: "Service booked successfully",
      serviceBookFailed:
        "Please enter your number and address correctly before booking",
  ...
  Nepali: {
    translation: {
      ...
      resetFailed: "पासवर्ड रिसेट गर्न असफल",
      failedToLoadBookings: "बुकिंगहरू लोड गर्न असफल",
      profileUpdateSuccess: "प्रोफाइल सफलतापूर्वक अपडेट गरियो",
      profileUpdateFailed: "प्रोफाइल अपडेट गर्न असफल",
      profileUpdateError: "प्रोफाइल अपडेट गर्ने क्रममा त्रुटि भयो",
      failedToLoadBookings: "बुकिंगहरू लोड गर्न असफल",
      reviewSubmitFailed: "समीक्षा पेश गर्न असफल",
      bookingCancelSuccess: "बुकिंग सफलतापूर्वक रद्द गरियो",
      bookingCancelFailed: "बुकिंग रद्द गर्न असफल",
      bookingCancelError: "बुकिंग रद्द गर्ने क्रममा त्रुटि भयो",
      registerFailed: "प्रयोगकर्ता दर्ता गर्न असफल",
      loginFailed: "लगइन गर्न असफल",
      authError: "प्रमाणीकरणको क्रममा त्रुटि भयो",
      loginPayment: "भुक्तानी प्रमाणित गर्न कृपया लगइन गर्नुहोस्",
      paymentVerifySuccess: "भुक्तानी सफलतापूर्वक प्रमाणित गरियो",
      loginToSubscribe: "योजना सदस्यता लिन तपाईं लगइन हुनुपर्छ।",
      paymentInitiateFailed: "भुक्तानी सुरु गर्न असफल",
      passwordResetFailed: "पासवर्ड रिसेट इमेल पठाउन असफल",
      passwordResetError: "पासवर्ड रिसेट इमेल पठाउने क्रममा त्रुटि भयो",
      serviceNotAvailable: "सेवा अहिले उपलब्ध छैन",
      enterContactDetails:
        "कृपया बुक गर्नु अघि आफ्नो नम्बर र ठेगाना सही रूपमा प्रविष्ट गर्नुहोस्",
      serviceBookSuccess: "सेवा सफलतापूर्वक बुक गरियो",
      serviceBookFailed:
        "कृपया बुक गर्नु अघि आफ्नो नम्बर र ठेगाना सही रूपमा प्रविष्ट गर्नुहोस्",
